...
public class MyArgumentsProvider implements ArgumentsProvider {
	...
	public Stream<? extends Arguments> provideArguments(ExtensionContext context) throws Exception {
		...
		int year = 2007;
		return Stream.of(
				Arguments.of(BookPublishedYearFilter.Before(year),
						Arrays.array(effectiveJava, codeComplete, mythicalManMonth, cleanCode, designPatterns)),
				Arguments.of(BookPublishedYearFilter.After(year),
						Arrays.array(effectiveJava, codeComplete, mythicalManMonth, cleanCode, designPatterns)));
	}
}
