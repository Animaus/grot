...
<div align="center">
	<b>${LNK_USR_HOME}</b><c:choose><c:when test='${user== null}'>&nbsp;|&nbsp;<a href="user/login">${LNK_USR_LOGIN}</a></c:when><c:otherwise>&nbsp;|&nbsp;<a href="/user/logout">${LOGIN_OUT}</a></c:otherwise></c:choose>&nbsp;|&nbsp;<a href="/user">${LNK_USR_MEMBERS}</a>
</div>
