		...
		<tr>
			<td>
				<form class="form-horizontal" method="post" action="j_security_check">
					...
					<p align="center">
						<i>${LOGIN_USR}:</i><br />
						<input type="text" name="j_username" placeholder="${LOGIN_USR}" size="50" maxlength="30">
					</p>
					<p align="center">
						<i>${LOGIN_PWD}:</i><br />
						<input type="password" name="j_password" placeholder="${LOGIN_PWD}" size="50" maxlength="30">
					</p>
				</form>
			</td>
		</tr>
