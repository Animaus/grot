			...
			<td valign="top" style="width: 50%;">
				<table style="width: 100%;">
					...
					<tr>
						...
						<td valign="top" rowspan="2"><sft:input path='member.lastName' /></td>
					</tr>
					<tr>
						<td valign="top">&nbsp;</td>
					</tr>
					...
					<tr>
						...
						<td valign="top" rowspan="2"><sft:radiobutton path='member.sex' value='m' />&nbsp;man <sft:radiobutton path='member.sex' value='f' />&nbsp;vrouw</td>
					</tr>
					<tr>
						<td valign="top">&nbsp;</td>
					</tr>
					<tr>
						...
						<td valign="top" rowspan="2"><sft:input path='member.dateBirthDisplay' placeholder='Vorm: jjjj-mm-dd' /></td>
					</tr>
					<tr>
						<td valign="top">&nbsp;</td>
					</tr>
					<tr>
						...
						<td valign="top" rowspan="2"><sft:input path='member.dateRegisteredDisplay' placeholder='Vorm: jjjj-mm-dd' /></td>
					</tr>
					<tr>
						<td valign="top">&nbsp;</td>
					</tr>
					<tr>
						...
						<td valign="top" rowspan="2"><sft:input path='member.password' /></td>
					</tr>
					<tr>
						<td valign="top">&nbsp;</td>
					</tr>
					<tr>
						...
						<td valign="top" rowspan="2"><sft:checkbox path='member.enabled' value='${enabled}' /> Actief</td>
					</tr>
					<tr>
						<td valign="top">&nbsp;</td>
					</tr>
					<tr>
						...
						<td valign="top">
							<!-- TODO 14 - Show users, rename roles TO userRoles -->
							<!-- TODO 14 - Show users, proper display and edit of roles -->
							<c:forEach items='${member.roles}' var='role'><c:set var="checked" value="false" /><c:forEach items="${member.userRoles}" var="userRole"><c:if test="${role==userRole}"><c:set var="checked" value="true" /></c:if></c:forEach><c:choose><c:when test="${checked==true}"><input name="roles" type="checkbox" value="${role}" checked />&nbsp;${role.name}<br />
							</c:when><c:otherwise><input name="roles" type="checkbox" value="${role}" />&nbsp;${role.name}<br /></c:otherwise></c:choose></c:forEach>
						</td>
					</tr>
				</table>
			</td>
			...
			<td valign="top" style="width: 50%;">
				<table style="width: 100%;">
					...
					<tr>
						...
						<td valign="top" rowspan="2"><sft:input path='member.streetName' /></td>
					</tr>
					<tr>
						<td valign="top">&nbsp;</td>
					</tr>
					<tr>
						...
						<td valign="top" rowspan="2"><sft:input path='member.streetNumber' /></td>
					</tr>
					<tr>
						<td valign="top">&nbsp;</td>
					</tr>
					<tr>
						...
						<td valign="top" rowspan="2"><sft:input path='member.zip' placeholder='Bijv.: 9999 XX' /></td>
					</tr>
					<tr>
						<td valign="top">&nbsp;</td>
					</tr>
					...
					<tr>
						...
						<td valign="top" rowspan="2"><sft:input path='member.phone1' placeholder='Bijv.: 0612345678' /></td>
					</tr>
					<tr>
						<td valign="top">&nbsp;</td>
					</tr>
					<tr>
						...
						<td valign="top" rowspan="2"><sft:input path='member.phone2' placeholder='Bijv.: 0612345678' /></td>
					</tr>
					<tr>
						<td valign="top">&nbsp;</td>
					</tr>
					<tr>
						...
						<td valign="top" rowspan="2"><sft:input path='member.email1' placeholder='Bijv.: iemand@domein.nl' /></td>
					</tr>
					<tr>
						<td valign="top">&nbsp;</td>
					</tr>
					<tr>
						...
						<td valign="top" rowspan="2"><sft:input path='member.email2' placeholder='Bijv.: iemand@domein.nl' /></td>
					</tr>
					<tr>
						<td valign="top">&nbsp;</td>
					</tr>
					<tr>
						...
						<td valign="top" rowspan="2"><sft:input path='member.countryName' /></td>
					</tr>
				</table>
			</td>
		</tr>
